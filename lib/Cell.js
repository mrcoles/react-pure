...
var PureCell = (function(_Component) {
    ...
    function PureCell() {
        ...
        return (0, _possibleConstructorReturn3.default)(
            this,
            Object.getPrototypeOf(PureCell).apply(this, arguments)
        );
    }
    ...
    (0, _createClass3.default)(PureCell, [
        {
            ...
            value: function render() {
                ...
                var lg = _props.lg;
                var xl = _props.xl;
                var props = (0, _objectWithoutProperties3.default)(_props, [
                    'className',
                    'size',
                    'sm',
                    'md',
                ...
                return _react2.default.createElement(
                    'div',
                    (0, _extends3.default)({ className: cls }, props)
                );
            }
        }
    ]);
...
PureCell.propTypes = {
    ...
    sm: _propTypes.string,
    md: _propTypes.string,
    lg: _propTypes.string,
    xl: _propTypes.string
};
